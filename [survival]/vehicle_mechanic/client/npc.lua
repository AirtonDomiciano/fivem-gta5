...
CreateThread(function()
    ...
    print('^3[DEBUG]^7 Sistema de interação iniciado. NPCs spawnados: ' .. #spawnedNPCs)
    ...
    while true do
        ...
        for i, npcData in pairs(spawnedNPCs) do
            if DoesEntityExist(npcData.ped) and npcData.coords then
                ...
                if distance <= Config.Target.distance then
                    ...
                    currentNPC = npcData
                    sleep = 0
                    -- print('^2[DEBUG]^7 Próximo do NPC: ' .. npcData.label .. ' - Distância: ' .. math.floor(distance * 100) / 100)
        ...
        if inRange and currentNPC then
            ...
            if IsControlJustPressed(0, 38) then -- 38 é a tecla E
                TriggerEvent('vehicle_mechanic:client:openMenu')
            end
        else
...
CreateThread(function()
    ...
    print('^2[Vehicle Mechanic]^7 ' .. #Config.NPCs .. ' NPCs spawnados com sucesso!')
end)
