...
Config.Fog = {
    ...
    WeatherResource = 'Renewed-Weathersync', -- resource file name most weather resources use setweather export
...
-- SandStorm
Config.StartCommand = "startsandstorm"
Config.StopCommand =  "stopsandstorm"
Config.SandStorm = {
...
Config.earthquakeCommand = "earthquake"
-- ash
Config.Ashscale = 5.0  
...
Config.Smokescale = 10.0 -- smoke effect scale
Config.SmokeLocations = { -- smoke locations that will show on a distance
    vector3(561.5, -2102.54, 50.77),
