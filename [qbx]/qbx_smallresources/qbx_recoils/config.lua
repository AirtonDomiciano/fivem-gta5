local recoils = {
    ...
    -- Handguns (Recoil aumentado para sobrevivência zumbi)
    [453432689] = 0.5,			--['weapon_pistol'] (era 0.3)
    [-1075685676] = 0.7,		--['weapon_pistol_mk2'] (era 0.5)
    [1593441988] = 0.4,			--['weapon_combatpistol'] (era 0.2)
    [584646201] = 0.5,			--['weapon_appistol'] (era 0.3)
    [911657153] = 0.3,			--['weapon_stungun'] (era 0.1)
    [-1716589765] = 0.8,		--['weapon_pistol50'] (era 0.6)
    [-1076751822] = 0.4,		--['weapon_snspistol'] (era 0.2)
    [-771403250] = 0.7,			--['weapon_heavypistol'] (era 0.5)
    [137902532] = 0.6,			--['weapon_vintagepistol'] (era 0.4)
    [1198879012] = 1.1,			--['weapon_flaregun'] (era 0.9)
    [-598887786] = 1.1,			--['weapon_marksmanpistol'] (era 0.9)
    [-1045183535] = 0.8,		--['weapon_revolver'] (era 0.6)
    [-879347409] = 0.8,			--['weapon_revolver_mk2'] (era 0.6)
    [-1746263880] = 0.5,		--['weapon_doubleaction'] (era 0.3)
    [-2009644972] = 0.5,		--['weapon_snspistol_mk2'] (era 0.3)
    [-1355376991] = 0.5,		--['weapon_raypistol'] (era 0.3)
    [727643628] = 0.5,			--['weapon_ceramicpistol'] (era 0.3)
    [-1853920116] = 0.5,		--['weapon_navyrevolver'] (era 0.3)
    [1470379660] = 0.5,			--['weapon_gadgetpistol'] (era 0.3)
